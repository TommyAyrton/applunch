...
class FondosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fondo" do
    assert_difference('Fondo.count') do
      post fondos_url, params: { fondo: { descripcion: @fondo.descripcion, estado: @fondo.estado, nombre: @fondo.nombre } }
    end
  ...
  test "should update fondo" do
    patch fondo_url(@fondo), params: { fondo: { descripcion: @fondo.descripcion, estado: @fondo.estado, nombre: @fondo.nombre } }
