...
class EntradasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entrada" do
    assert_difference('Entrada.count') do
      post entradas_url, params: { entrada: { descripcion: @entrada.descripcion, estado: @entrada.estado, imagen: @entrada.imagen, nombre: @entrada.nombre } }
    end
  ...
  test "should update entrada" do
    patch entrada_url(@entrada), params: { entrada: { descripcion: @entrada.descripcion, estado: @entrada.estado, imagen: @entrada.imagen, nombre: @entrada.nombre } }
